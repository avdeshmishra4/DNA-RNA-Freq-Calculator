...
public class MainExecutor {
	...
	public static void main(String[] args) throws IOException {
		...
		Scanner scanner = new Scanner(new InputStreamReader(System.in));		// To read input from console
		System.out
...
//		E:/SPRING2014/bioinformatics-course/dataset/input/Habronattus oregonensisProtSeq.fasta
//		Enter a directory and file name to write sequence in fasta format
//		E:/SPRING2014/bioinformatics-course/dataset/output/Habronattusprotseqeoutput.fasta
//		Enter a directory and file name to write relative frequencies
//		E:/SPRING2014/bioinformatics-course/dataset/output/relativeFreqH-O-Prot.txt
		
		
//		Enter a directory and file name that you want to process
//		E:/SPRING2014/bioinformatics-course/dataset/input/Habronattus oregonensisDNARNASeq.fasta
		// E:/SPRING2014/bioinformatics-course/dataset/assignment2/input/Habronattus oregonensisDNARNASeq.fasta
//		Enter a directory and file name to write sequence in fasta format
//		E:/SPRING2014/bioinformatics-course/dataset/output/Habronattus oregonensisDNARNASeqOutput.fasta
//		Enter a directory and file name to write relative frequencies
//		E:/SPRING2014/bioinformatics-course/dataset/output/relativeFreq.txt
		...
		if (isProtein) {
			...
			BufferedReader proteinReader = BufferReaderAndWriter
					.getReader(ipFile);
			ProteinFrequencyCalculator fcProtein = new ProteinFrequencyCalculator();
			...
			//	E:/SPRING2014/temp/piscesdataset.txt
			//	E:/SPRING2014/temp/piscesdatasetFasta.txt
			//  E:/SPRING2014/temp/relativeFreq.txt
				// buffer writer writes the ID and sequence in fasta file
				
				if(seq.equals(null)){
					
					System.out.println("i am at null"); 
			...
			System.out.println("Relative Frequency of # == "
					+ String.valueOf(fcProtein.relativeFreqOthers));
			...
			System.out.println("Count of Total Nucleic Acid == "
